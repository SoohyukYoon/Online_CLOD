...
dataset = 'shift'
output_dataset = 'SHIFT_hanhwa_scenario5'
dataset_dir = f'data'
...
dataset_dirs = ['hanhwa_shift_daytime_rainy', 'hanhwa_shift_dawndusk_foggy', 'hanhwa_shift_night_clear', 'hanhwa_shift_dawndusk_cloudy', 'hanhwa_shift_daytime_rainy']

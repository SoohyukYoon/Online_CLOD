...
dataset = 'shift'
output_dataset = 'SHIFT_hanhwa_scenario4'
dataset_dir = f'data'
...
dataset_dirs = ['hanhwa_shift_daytime_foggy', 'hanhwa_shift_dawndusk_clear', 'hanhwa_shift_night_rainy', 'hanhwa_shift_dawndusk_cloudy', 'hanhwa_shift_daytime_overcast']

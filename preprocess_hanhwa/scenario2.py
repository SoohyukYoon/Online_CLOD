...
dataset = 'shift'
output_dataset = 'SHIFT_hanhwa_scenario2'
dataset_dir = f'data'
...
dataset_dirs = ['hanhwa_shift_daytime_clear1', 'hanhwa_shift_dawndusk_cloudy', 'hanhwa_shift_night_foggy', 'hanhwa_shift_dawndusk_overcast', 'hanhwa_shift_daytime_clear2']

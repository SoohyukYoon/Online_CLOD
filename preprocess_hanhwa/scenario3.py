...
dataset = 'shift'
output_dataset = 'SHIFT_hanhwa_scenario3'
dataset_dir = f'data'
...
dataset_dirs = ['hanhwa_shift_daytime_cloudy', 'hanhwa_shift_dawndusk_rainy', 'hanhwa_shift_night_foggy', 'hanhwa_shift_dawndusk_overcast', 'hanhwa_shift_daytime_clear1']

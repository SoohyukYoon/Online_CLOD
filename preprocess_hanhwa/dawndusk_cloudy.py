...
def filter_dataset(original_path, output_path, target_dataset):
    ...
    for i in range(len(labels_data['images'])):
        if labels_data['images'][i]['attributes']['weather_coarse'] == 'cloudy' and labels_data['images'][i]['attributes']['timeofday_coarse'] == 'dawn/dusk':
...
if __name__ == "__main__":
    ...
    output_path   = Path("./data/hanhwa_shift_dawndusk_cloudy")

...
def filter_dataset(original_path, output_path, target_dataset):
    ...
    for i in range(len(labels_data['images'])):
        if labels_data['images'][i]['attributes']['weather_coarse'] == 'foggy' and labels_data['images'][i]['attributes']['timeofday_coarse'] == 'night':
...
if __name__ == "__main__":
    ...
    output_path   = Path("./data/hanhwa_shift_night_foggy")

...
def make_stream(dataset_path, target_datasets, repeats, sigmas, seeds):

    clses = list(range(15, 20))
    cls_list = {
        15: 'pottedplant',
        16: 'sheep',
        17: 'sofa',
    ...
    for repeat in repeats:
        for sigma in sigmas:
            for seed in seeds:
                ...
                with open(f'collections/VOC_15_5_sigma{int(sigma*100)}_repeat{repeat}_seed{seed}.json', 'w') as fp:
                    json.dump(data, fp)

if __name__ == "__main__":

    dataset_path = Path("./data/voc")
    target_dataset = 'train2007'
    target_datasets = ['train2007', 'train2012', 'val2007', 'val2012']
    ...
    make_stream(dataset_path, target_datasets, repeats, sigmas, seeds)
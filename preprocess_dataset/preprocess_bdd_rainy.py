...
def filter_dataset(original_path, output_path, target_dataset):
    ...
    for i in range(len(labels_data['images'])):
        if (labels_data['images'][i]['attributes']['weather'] == 'rainy' or labels_data['images'][i]['attributes']['weather'] == 'snowy') and labels_data['images'][i]['attributes']['timeofday'] == 'daytime':
...
if __name__ == "__main__":
    ...
    output_path   = Path("./data/bdd100k_rainy")

...
def filter_dataset(original_path, output_path, target_dataset):
    ...
    for i in range(len(labels_data['images'])):
        if labels_data['images'][i]['attributes']['weather_coarse'] == 'clear' and labels_data['images'][i]['attributes']['timeofday_coarse'] == 'daytime':
...
if __name__ == "__main__":
    ...
    output_path   = Path("./data/shift_source_equalized")

...
def filter_dataset(original_path, output_path, target_dataset):
    ...
    for i in range(len(labels_data['images'])):
        if labels_data['images'][i]['sensor'] == 1 and \
            labels_data['images'][i]['attributes']['season'] == 2 and \
            labels_data['images'][i]['attributes']['night'] == 1:
...
if __name__ == "__main__":
    ...
    output_path   = Path("./data/military_synthetic_domain_winter")

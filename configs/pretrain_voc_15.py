...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.output_dir = './damo_pretrain_outputs_w/voc_15'
        # optimizer
        self.train.batch_size = 16 * 8
        ...
        self.dataset.val_ann = ('voc_15_val',)
        ...
        self.dataset.class_names = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable', 'dog', 'horse', 'motorbike', 'person']

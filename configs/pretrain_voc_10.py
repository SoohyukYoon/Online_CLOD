...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.output_dir = './pretrain_outputs/voc_10'
        # optimizer
        ...
        self.dataset.val_ann = ('voc_10_test2007',)
        ...
        self.dataset.class_names = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow']

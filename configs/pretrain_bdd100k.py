...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.output_dir = './damo_pretrain_outputs_w/bdd100k'
        # optimizer
        ...
        self.dataset.val_ann = ('bdd_val_pretrain',)
        ...
        self.dataset.class_names = ["pedestrian", "rider", "car", "bus", "truck","bicycle", "motorcycle", "traffic light", "traffic sign", "train", "trailer", "other person", "other vehicle" ]

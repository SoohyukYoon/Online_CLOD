...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.output_dir = './damo_joint_train_outputs/visdrone_3_4'
        # optimizer
        ...
        self.dataset.val_ann = ('visdrone_val',)
        ...
        self.dataset.class_names = ['people', 'bicycle', 'car', 'van', 'truck', 'motorcycle', 'bus']

...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.ckpt_interval_epochs = 50
        self.miscs.output_dir = './damo_pretrain_outputs_w/tod'
        # optimizer
        ...
        self.dataset.val_ann = ('TOD_winter_class_new_val',)
        ...
        self.dataset.class_names = ["person", "truck", "van", "motorcycle", "bicycle", "extraclass", "bus","car"]
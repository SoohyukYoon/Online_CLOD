...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.output_dir = './damo_pretrain_outputs_w/shift_equalized'
        # optimizer
        ...
        self.dataset.val_ann = ('shift_val_pretrain_equalized',)
        ...
        self.dataset.class_names = ['pedestrian', 'car', 'truck', 'bus', 'motorcycle', 'bicycle']

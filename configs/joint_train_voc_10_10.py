...
class Config(MyConfig):
    def __init__(self):
        ...
        self.miscs.output_dir = './damo_joint_train_outputs_w/voc_10_10'
        # optimizer
        ...
        self.dataset.class_names = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable', 'dog', 'horse', 'motorbike', 'person', 'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor']

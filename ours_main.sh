...
# CIL CONFIG
NOTE="er_freq_balanced2_loss" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="er_selection_balanced2"
...
do
    ...
    --note $NOTE --eval_period $EVAL_PERIOD --imp_update_period $IMP_UPDATE_PERIOD $USE_AMP # > damo_useall_${DATASET}_${MODE}_selectmode${SELECTION_METHOD}_balance05_hard_9_mem${MEM_SIZE}_lr${LR}_online_iter${ONLINE_ITER}_seed${RND_SEED}_mosaic${MOSAIC}_mixup${MIXUP}.out 2>&1 &
done
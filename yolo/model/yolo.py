...
class YOLO(nn.Module):
    ...
    def set_loss_function(self, cfg, vec2box, num_classes=None):
        from yolo.tools.loss_functions import create_loss_function
        self.model.cfg = cfg
        self.loss_fn = create_loss_function(cfg, vec2box, num_classes)
    ...
    def train_step(self, batch):
        ...
        if aux is None or main is None:
            raise ValueError("Missing output keys 'aux_head' or 'main_head' for loss computation")
        return self.loss_fn(aux, main, targets)
